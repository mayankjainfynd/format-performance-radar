...
const FormatWiseSalesChart: React.FC<FormatWiseSalesChartProps> = ({ data }) => {
  ...
  const extendedData = [
    { name: "Smart Bazaar", value: 25.7, salesValue: "₹11.50 Cr" },
    { name: "FreshPik", value: 21.9, salesValue: "₹9.75 Cr" },
    { name: "Reliance Smart", value: 17.3, salesValue: "₹8.90 Cr" },
    { name: "JioMart", value: 19.9, salesValue: "₹7.75 Cr" },
    { name: "JioMart Digital", value: 15.1, salesValue: "₹6.75 Cr" },
  ];
